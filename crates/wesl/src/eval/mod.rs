...
pub use to_expr::*;
pub use ty::*;
pub use wgsl_types::{ShaderStage, builtin::*, conv::*, inst::*, tplt::*, ty::*, ty_ctx::*};
...
pub struct Context<'s> {
    ...
    pub(crate) ty_ctx: &'s mut TyContext,
...
impl<'s> Context<'s> {
    pub fn new(source: &'s TranslationUnit, ty_ctx: &'s mut TyContext) -> Self {
        Self {
            source,
