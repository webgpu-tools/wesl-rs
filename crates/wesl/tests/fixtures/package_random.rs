...
pub static MODULE: StaticPackageModule = StaticPackageModule {
    name: "random",
    source: "",
    submodules: &[&r#noise::MODULE, &r#hash::MODULE],
};
pub mod r#noise {
